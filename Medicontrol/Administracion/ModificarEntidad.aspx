<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="ModificarEntidad.aspx.cs" Inherits="Medicontrol.Administracion.Formulario_web117" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="btn-group btn-group-justified" role="group" aria-label="...">
            ...
            <div class="btn-group" role="group">
                <asp:Button BackColor="#999999" Enabled="true" runat="server" PostBackUrl="~/Administracion/ModificarEntidad.aspx" ID="btn_Actualizar" CssClass="btn btn-primary" Text="Modificar" />
            </div>
            <div class="btn-group" role="group">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                ...
                <asp:TextBox runat="server" CssClass="form-control" ID="txt_nit" ReadOnly="true"></asp:TextBox>
                <br />
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
