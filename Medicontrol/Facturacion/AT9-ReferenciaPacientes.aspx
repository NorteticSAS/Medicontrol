<%@ Page Title="" Language="C#" MasterPageFile="~/Facturacion/Facturacion.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="AT9-ReferenciaPacientes.aspx.cs" Inherits="Medicontrol.Facturacion.WebForm9" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset>
        <legend>Referencia de pacientes Anexo técnico 9 Res. 4331/12</legend>
        <br />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server"
        ...
        <ContentTemplate>
            ...
            <fieldset onkeydown="return (event.keyCode!=13)">
                <legend>PROFESIONAL QUE SOLICITA LA REFERENCIA</legend>
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <asp:Label runat="server" ID="Label15" Text="Servicio que solicita la referencia"></asp:Label>
                        <asp:TextBox runat="server" CssClass="form-control" ID="txt_serviciosolicita" ReadOnly="false"></asp:TextBox>
                        <br />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                        <asp:Label runat="server" ID="Label16" Text="Servicio para el cual se solicita la referencia"></asp:Label>
                        <asp:TextBox runat="server" CssClass="form-control" ID="txt_servicioparareferencia" ReadOnly="false"></asp:TextBox>
                        <br />
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <asp:Label runat="server" ID="Label17" Text="Dilegencie en el orden indicado el resumen de anamnesis y examen físico, fechas y resultados de exámenes auxiliares de diágnostico, resumen de la evolución, diágnostico, complicaciones, tratamientos aplicados y motivos de remisión. Al finalizar el profesional tratante debe firmar la solicitud de referencia y anotar su registro profesional." ForeColor="Red"></asp:Label>
