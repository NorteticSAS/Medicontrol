    ...
    public partial class Formulario_web16 : System.Web.UI.Page
    {
        ...
        protected void ddl_contrato_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (leer6.Read() == true)
            {
                ...
                txt_numafiliados.Text = leer6["Afiliados"].ToString();
                txt_capita.Text = leer6["PorcenCapita"].ToString();
                txt_municipio.Text = leer6["Municipio"].ToString();
                txt_upc.Text = txt_upc2.Text;
        ...
        protected void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            string insertar = "INSERT INTO FacturaCapitada(NumFactura, PrefijoFactura, CodIPS, FechaExpedicion, CodEntidad, CodContrato, CodContrato1, MesServicio, YearServicio, FechaInicial, FechaFinal, Valor, ValorEnLetras, NumAfiliados, PorcentajeCap, Municipio, Servicios, Estado) VALUES('" + this.NumFactura.Text + "', '" + this.Prefijo.Text + "', '" + this.ddl_ips.SelectedValue + "', '" + FechaExp + "', '" + this.ddl_entidad.SelectedValue + "', '" + this.ddl_contrato.SelectedValue + "', '" + this.txt_numcontrato.Text + "', '" + this.ddl_mes.SelectedItem.Text.ToUpper() + "', '" + this.ddl_año.SelectedItem + "', '" + FechaIni + "', '" + FechaFin + "', '" + this.ValorMesNormal.Text + "', '" + ValorEnLetras + "', '" + this.txt_numafiliados.Text + "', '" + this.txt_capita.Text + "', '" + this.txt_municipio.Text.ToUpper() + "', '" + this.ddl_servicio.SelectedItem.Text.ToUpper() + "', '0')";
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        txt_numafiliados.Text = string.Empty;
        ...
        private void ImprimirFactura(string sql)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename= FacturaCapitada"+NumFactura.Text+"." + fileNameExtension);
