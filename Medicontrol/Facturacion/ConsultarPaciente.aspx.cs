...
namespace Medicontrol.Facturacion
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        private void fillgrilla()
        {
            ...
            {
                SqlDataAdapter da = new SqlDataAdapter("SELECT Id, CodEntidad, NombreEntidad, CodContrato, NombreContrato, Documento FROM PacientesEntidadContrato WHERE Documento='" + this.txt_buscar.Text + "'", cn);
                da.Fill(dt);
            }
