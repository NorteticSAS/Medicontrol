<%@ Page Title="" Language="C#" MasterPageFile="~/Facturacion/Facturacion.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ModificarPaciente.aspx.cs" Inherits="Medicontrol.Facturacion.WebForm3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="btn-group btn-group-justified" role="group" aria-label="...">
        ...
        <div class="btn-group" role="group">
            <asp:Button BackColor="#999999" PostBackUrl="~/Facturacion/ModificarPaciente.aspx" runat="server" ID="btn_Buscar" CssClass="btn btn-primary" Text="Buscar" />
        </div>
       <%-- <div class="btn-group" role="group">
            <asp:Button BackColor="#999999" Enabled="true" runat="server" PostBackUrl="~/Facturacion/ModificarPaciente.aspx" ID="btn_Actualizar" CssClass="btn btn-primary" Text="Modificar" />
        </div>--%>
       <%-- <div class="btn-group" role="group">
            <asp:Button Enabled="false" runat="server" ID="btn_Eliminar" OnClick="btn_Eliminar_Click" CssClass="btn btn-primary" Text="Eliminar" />
        </div>--%>
    </div>

    <hr />
    <h3>Buscar/Modificar Datos del Paciente</h3>
    <br />
