...
namespace Medicontrol.Facturacion
{
    public partial class WebForm9 : System.Web.UI.Page
    {
        ...
        protected void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO Res4331_AT9_REF(NumInforme, documento, fechainforme, TDI_RC, TDI_TI, TDI_CC, TDI_CE, TDI_PA, TDI_AS, TDI_MS, A_DOCUMENTO, NOMBRE1, NOMBRE2, APELLIDO1, APELLIDO2, TDIRC, TDITI, TDICC, TDICE, TDIPA, TDIAS, TDIMS, A_TIPODOC, DIRECCION, TELEFONO, DEPARTAMENTO, MUNICIPIO, CODPROFSOLICITA, SERVICIOSOLICITA, SERVICIOREFIERE, INFOCLINICA, CodEntidad, CodUsuario) VALUES('"+this.txt_numInforme.Text+"', '"+this.txt_cedula.Text+ "', '"+fecha+"', '"+txt_tipodocvictimarc.Text+ "', '"+txt_tipodocvictimati.Text+ "', '"+txt_tipodocvictimacc.Text+ "', '"+txt_tipodocvictimace.Text+ "', '"+txt_tipodocvictimapa.Text+ "', '"+txt_tipodocvictimaas.Text+ "', '"+txt_tipodocvictimams.Text+ "', '"+txt_respDocumento.Text+ "', '"+txt_respNombre1.Text+ "', '"+txt_respNombre2.Text+ "', '"+txt_respApellido1.Text+ "', '"+txt_respApellido2.Text+ "', '"+docurc.Text+ "', '"+docuti.Text+ "', '"+docucc.Text+ "', '"+docuce.Text+ "', '"+docupa.Text+ "', '"+docuas.Text+ "', '"+docums+ "', '"+ddl_respTipoDocumento.SelectedItem+ "', '"+txt_direccion.Text+ "', '"+txt_respTelefono.Text+ "', '"+ddl_departamento.SelectedValue+ "','"+ddl_municipio.SelectedValue+ "', '"+ddl_profesionales.SelectedValue+ "', '"+txt_serviciosolicita.Text+ "', '"+txt_servicioparareferencia.Text+ "', '"+txt_infoclinica.Text+ "', '"+CodEntidad.Text+ "', '"+CodigoSesion.Text+"')";
            ...
            else
            {
                ...
                txt_servicioparareferencia.Text = string.Empty;
                txt_serviciosolicita.Text = string.Empty;
